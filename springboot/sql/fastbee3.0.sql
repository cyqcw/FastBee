...
INSERT INTO `iot_device` VALUES (144, '★海尔空气检测器', 41, '★智能开关产品', 1, 'cyqcw', 1, 'admin', 'D138QFH77I509', NULL, 1.20, 3, 1, 0, 3, '[{\"id\": \"temperature\", \"ts\": \"2024-06-02 00:28:32.279\", \"name\": \"空气温度\", \"value\": \"19.62\", \"shadow\": \"19.62\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"switch\", \"name\": \"设备开关\", \"value\": \"\", \"shadow\": \"\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"humidity\", \"ts\": \"2024-06-02 00:28:32.319\", \"name\": \"空气湿度\", \"value\": \"36.45\", \"shadow\": \"36.45\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"report_monitor\", \"name\": \"上报数据\", \"value\": \"\", \"shadow\": \"\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"gear\", \"name\": \"运行档位\", \"value\": \"\", \"shadow\": \"\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"brightness\", \"ts\": \"2024-06-02 00:28:32.401\", \"name\": \"室内亮度\", \"value\": \"4458\", \"shadow\": \"4458\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"light_color\", \"name\": \"灯光色值\", \"value\": \" , , , \", \"shadow\": \" , , , \", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"co2\", \"ts\": \"2024-06-02 00:28:32.36\", \"name\": \"二氧化碳\", \"value\": \"416\", \"shadow\": \"416\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"reset\", \"name\": \"设备重启\", \"value\": \"\", \"shadow\": \"\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"message\", \"name\": \"屏显消息\", \"value\": \"\", \"shadow\": \"\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"irc\", \"name\": \"射频遥控\", \"value\": \"\", \"shadow\": \"\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}, {\"id\": \"status\", \"name\": \"上报状态\", \"value\": \"\", \"shadow\": \"\", \"isChart\": 0, \"isHistory\": 0, \"isMonitor\": 0, \"isReadonly\": 0}]', '北京', '127.0.0.1', 116.644042, 39.740986, '2024-06-01 00:00:00', '{\"chip\": \"esp8266\", \"name\": \"device\", \"author\": \"cyqcw\", \"create\": \"2022 - 06 - 06\", \"version\": 1.6}', NULL, '0', '', '2024-06-01 22:19:47', '', '2024-06-02 00:31:53', NULL, 0, NULL);
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '设备日志' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `iot_event_log`  (
  ...
  `remark` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '事件日志' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `iot_product_authorize` VALUES (3, '8A15488EA3A04286A9218C1DD292C711', 41, NULL, NULL, NULL, NULL, 1, '0', 'admin', '2024-05-31 14:00:49', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 344 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '物模型模板' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_role` VALUES (6, '演示用户', 'show', 7, '1', 1, 1, '0', '0', 'cyqcw', '2024-06-01 22:02:08', 'admin', '2024-06-02 00:42:58', NULL);
...
INSERT INTO `sys_role_menu` VALUES (6, 1046);
INSERT INTO `sys_role_menu` VALUES (6, 1047);
INSERT INTO `sys_role_menu` VALUES (6, 1048);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '蜂信管理员', '00', '164770707@qq.com', '15888888888', '0', '/profile/avatar/2024/06/01/blob_20240601182115A002.png', '$2a$10$kKeZptrTnSlm0fencX4U2eq.QiaukDs.DckiUsMCwVTxh0IS2LRQ.', '0', '0', '127.0.0.1', '2024-06-02 00:54:41', 'admin', '2021-12-15 21:36:18', '', '2024-06-02 00:54:41', '管理员');
...
INSERT INTO `sys_user` VALUES (13, 100, 'cyqcw', 'cyqcw', '00', 'cyqcw@foxmail.com', '15518441162', '0', '', '$2a$10$u54Z7WzGyGqZSvkadDn.rO9P5FCMBAdNsSNN3T5dPcn.SYAHiO0Ie', '0', '0', '127.0.0.1', '2024-06-02 01:00:36', 'admin', '2024-06-01 21:52:59', 'cyqcw', '2024-06-02 01:00:35', NULL);
